...
EditorHelperImpl.prototype.getToolsSystemPrompt = function() {
	...
	let prompt = "\
You are an AI assistant integrated into the MiaotongDoc " + ctx.name + " editor.\n\
...
3. If no specialized tool fits, use the \"writeMacro\" tool. It can execute any JavaScript code using the MiaotongDoc " + ctx.apiName + ".\n\
...
EditorHelperImpl.prototype.getSystemPrompt = function() {
	...
	let systemPrompt = "\
You are an AI assistant integrated into the MiaotongDoc " + ctx.name + " editor with function-calling capabilities.\n\
\n\
BEHAVIOR RULES:\n\
...
- If no specialized function fits, use the \"writeMacro\" function. It can execute any JavaScript code using the MiaotongDoc " + ctx.apiName + ".\n\
