...
HELPERS.word.push((function(){
	let func = new RegisteredFunction({
		"name": "writeMacro",
		"description": `Executes a JavaScript macro using the MiaotongDoc Document API (text documents / Word).
...
The return value of the last expression will be the tool's output.`,
		"parameters": {
			...
			"properties": {
				"code": {
					"type": "string",
					"description": `Valid JavaScript code using the MiaotongDoc Document API to execute directly via eval. Rules:
- Use only the MiaotongDoc Document API (Api, ApiDocument, ApiParagraph, ApiRun, ApiTable, etc.)
...
HELPERS.slide.push((function(){
	let func = new RegisteredFunction({
		"name": "writeMacro",
		"description": `Executes a JavaScript macro using the MiaotongDoc Presentation API.
...
The return value of the last expression will be the tool's output.`,
		"parameters": {
			...
			"properties": {
				"code": {
					"type": "string",
					"description": `Valid JavaScript code using the MiaotongDoc Presentation API to execute directly via eval. Rules:
- Use only the MiaotongDoc Presentation API (Api, Api.GetPresentation(), etc.)
- Do NOT wrap the code in a function or IIFE — output only the statements to execute directly
- Do NOT include any explanation, comments, or markdown — output raw JavaScript only
...
HELPERS.cell.push((function(){
	let func = new RegisteredFunction({
		"name": "writeMacro",
		"description": `Executes a JavaScript macro using the MiaotongDoc Spreadsheet API.
...
The return value of the last expression will be the tool's output.`,
		"parameters": {
			...
			"properties": {
				"code": {
					"type": "string",
					"description": `Valid JavaScript code using the MiaotongDoc Spreadsheet API to execute directly via eval. Rules:
- Use only the MiaotongDoc Spreadsheet API (Api, ApiWorksheet, ApiRange, etc.)
- Do NOT wrap the code in a function or IIFE — output only the statements to execute directly
- Do NOT include any explanation, comments, or markdown — output raw JavaScript only
